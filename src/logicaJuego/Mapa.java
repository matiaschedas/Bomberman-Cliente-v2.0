...
public class Mapa implements Serializable{
	...
	private ArrayList<Bomberman> jugadoresLocal;
	private int cantJug;
	...
	public Mapa(int cantJu) {
		this.matrizMapa = new Entidad[FILMAX][COLMAX];
		this.matrizCosas = new Entidad[FILMAX][COLMAX];
		this.cantJug=cantJu;
		
		jugadoresLocal = new ArrayList<Bomberman>();
		jugadoresLocal.add(new Bomberman(1,1,"p1"));
		jugadoresLocal.add(new Bomberman(9,13,"p2"));
	...
	public void creaBomberman2() {
		matrizMapa[1][1]=new Bomberman(1,1,"p1");
		matrizMapa[9][13]=new Bomberman(9,13,"p2");
	}
	...
	public ArrayList<Bomberman> getJugadoresLocal() {
		return jugadoresLocal;
	}

	public void setJugadoresLocal(ArrayList<Bomberman> jugadoresLocal) {
